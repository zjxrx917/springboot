 ...
 * generated in the com.csdn.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://webservice.csdn.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://webservice.csdn.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.csdn.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.csdn.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.csdn.com/", name = "queryWeather")
